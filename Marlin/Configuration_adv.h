...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  53, 36 }, { X_BED_SIZE-51,  36 }, { X_BED_SIZE-51, X_BED_SIZE-34 }, { 20, X_BED_SIZE-34 } }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 60*60, 60*60, 5*60, 8*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define MESH_MIN_Y 15 //MESH_INSET //почему-то отступ в 10мм на самом деле будет 15мм ( +5 мм), по остольным осям норм
  #define MESH_MAX_X X_BED_SIZE - 15 //(MESH_INSET)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       18  // (mm) Unload initial retract length.
