 ...
 */
#define CONFIGURATION_H_VERSION 02010300  //02.03.25
...
#define E1_DRIVER_TYPE TMC2209 //MSU
...
/*
Внимание. Необходимо включить в слайсере печать в режиме относительной экструзии!!
*/
//MSU
#define MSU
#if ENABLED(MSU)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 100, 35000 }
...
#define LCD_BED_TRAMMING
  ...
  //#define BED_TRAMMING_INSET_LFRB { 30, 30, 45, 19, 40 } // (mm) Left, Front, Right, Back insets
