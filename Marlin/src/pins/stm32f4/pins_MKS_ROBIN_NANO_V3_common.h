...
//
  ...
  #define FIL_RUNOUT_PIN                    PE6   //SFS runout
#endif
#ifndef FIL_RUNOUT2_PIN
  #define FIL_RUNOUT2_PIN                   PA4
#endif
//BTT SFS 2.0 красный(+) и синий(runout) дальше от края в PE6, зеленый(motion) и черный(gnd) в PA4
#ifndef FIL_MOTION1_PIN
  #define FIL_MOTION1_PIN						        PA4   //SFS motion	
#endif
